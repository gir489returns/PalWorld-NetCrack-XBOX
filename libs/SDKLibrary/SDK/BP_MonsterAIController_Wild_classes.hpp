...
{
public:
	uint8                                        Pad_17AA[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	FMulticastInlineDelegateProperty_            BattleStartEvent;                                  // 0x558(0x10)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
