...
public:
	...
	class UImage*                                Image_69;                                          // 0x470(0x8)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UWBP_PalDebugInfo_C*                   WBP_PalDebugInfo;                                  // 0x478(0x8)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UWBP_Title_WorldMenu_Head_C*           WBP_Title_WorldMenu_Head;                          // 0x480(0x8)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	...
	TArray<class FString>                        OfficialServerAddress;                             // 0x678(0x10)(Edit, BlueprintVisible, DisableEditOnInstance)

	static class UClass* StaticClass();
	static class UWBP_JoinGame_C* GetDefaultObj();

	void RequestGetServerListBP(enum class EPalUIServerListFilterType Type, const class FString& Region, bool IsCleanCache, bool NextPage, const class FString& Word);
	...
	void DisplayServer(const struct FPalUIServerDataCollectInfo& K2Node_MakeStruct_PalUIServerDataCollectInfo, TArray<struct FPalUIServerDisplayData>& CallFunc_CollectServerDisplayInfo_OutServerInfo);
	...
	void OnInitialized();
	void _____K_e_(class UPalHUDDispatchParameterBase* Param);
