...
public:
	...
	uint8                                        BitPad_FA : 2;                                     // Fixing Bit-Field Size  [ Dumper-7 ]
	...
	uint8                                        BitPad_FC : 5;                                     // Fixing Bit-Field Size  [ Dumper-7 ]
	...
	uint8                                        Pad_1E3C[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1E3E[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1E54[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1E56[0x3];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1E8C[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1E8F[0x50];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1ECE[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	TArray<struct FFoliageTypeObject>            FoliageTypes;                                      // 0x40(0x10)(Edit, ZeroConstructor, NativeAccessSpecifierPrivate)
	uint8                                        Pad_1ED0[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1ED4[0xA0];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	TArray<struct FProceduralFoliageInstance>    InstancesArray;                                    // 0xD0(0x10)(ZeroConstructor, NativeAccessSpecifierPrivate)
	uint8                                        Pad_1ED5[0x90];                                    // Fixing Size Of Struct [ Dumper-7 ]
