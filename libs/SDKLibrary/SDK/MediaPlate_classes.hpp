...
{
public:
	uint8                                        Pad_DE9[0x8];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_DF0[0x1];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_E1C[0x1];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_E22[0x28];                                     // Fixing Size Of Struct [ Dumper-7 ]
