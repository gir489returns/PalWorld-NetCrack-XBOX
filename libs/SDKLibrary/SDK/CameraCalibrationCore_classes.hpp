...
public:
	...
	uint8                                        Pad_1302[0xF];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1380[0xA8];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_13E6[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_13ED[0xF];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_13F2[0x20];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1465[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
