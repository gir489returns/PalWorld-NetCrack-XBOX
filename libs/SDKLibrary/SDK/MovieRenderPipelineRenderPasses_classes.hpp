...
{
public:
	uint8                                        Pad_1298[0x130];                                   // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_12A5[0x48];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_12D1[0x7];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_12D7[0x20];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_12DF[0x6];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_12F1[0x7];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1305[0x60];                                    // Fixing Size Of Struct [ Dumper-7 ]
