...
public:
	...
	uint8                                        Pad_2AB4[0x4];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_2ABB[0x4];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_2AC1[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2AC2[0x4];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
