...
public:
	...
	uint8                                        Pad_682[0x8];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_685[0x1AB];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_686[0x10];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_68B[0x5];                                      // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_68D[0x4];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_68F[0x3];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_698[0x4];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
