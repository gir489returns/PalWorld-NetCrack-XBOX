...
public:
	...
	uint8                                        Pad_299E[0x4];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_29A3[0x4];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_29A8[0x4];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_29AB[0x7];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        BitPad_1A1 : 6;                                    // Fixing Bit-Field Size  [ Dumper-7 ]
	...
	uint8                                        Pad_29B2[0x18];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_29B3[0x7];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
