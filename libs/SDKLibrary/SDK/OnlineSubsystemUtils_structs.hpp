...
{
public:
	uint8                                        Pad_FAE[0x120];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_FDF[0x4];                                      // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_FE8[0x4];                                      // Fixing Size After Last Property  [ Dumper-7 ]
