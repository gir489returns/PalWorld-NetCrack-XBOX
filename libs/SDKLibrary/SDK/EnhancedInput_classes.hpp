...
{
public:
	uint8                                        Pad_1934[0x38];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1978[0x7];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1A01[0x1A0];                                   // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1A06[0x50];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1A08[0xA0];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1A0A[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1A84[0x7];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1A95[0x5];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1A99[0x30];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1AE0[0x4];                                     // Fixing Size Of Struct [ Dumper-7 ]
