...
public:
	...
	uint8                                        Pad_2848[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_2853[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	struct FGuid                                 CallFunc_GetId_ReturnValue;                        // 0x68(0x10)(ConstParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UPalIndividualCharacterParameter*      CallFunc_GetIndividualCharacterParameterByActor_ReturnValue; // 0x78(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class AController*                           CallFunc_GetController_ReturnValue;                // 0x80(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TScriptInterface<class IBP_AIController_Interface_Invader_C> K2Node_DynamicCast_AsBP_AIController_Interface_Invader; // 0x88(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class APalAIController*                      K2Node_DynamicCast_AsPal_AIController;             // 0xD8(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class UBP_PalAIBlackboard_Common_C*          CallFunc_GetMyBB_PalBrackboard;                    // 0x100(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	enum class EPalCharacterLocationType         CallFunc_Get_Character_Location_Type_CharacterLocationType; // 0x108(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class APalAIController*                      K2Node_DynamicCast_AsPal_AIController_1;           // 0x138(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class AActor*                                CallFunc_AdjustActorToFloor_ReturnValue;           // 0x148(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
