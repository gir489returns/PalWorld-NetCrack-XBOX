...
{
public:
	uint8                                        Pad_274B[0x40];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_274C[0x40];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_274E[0x40];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
