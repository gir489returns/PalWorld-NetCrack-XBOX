...
{
public:
	uint8                                        Pad_212C[0x40];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_212D[0x40];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_2130[0x40];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
