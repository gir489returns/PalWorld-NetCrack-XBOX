...
{
public:
	uint8                                        Pad_2033[0x40];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_2036[0x40];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_203C[0x40];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
