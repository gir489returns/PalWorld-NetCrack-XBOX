...
public:
	...
	uint8                                        Pad_3F6C[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	double                                       InvaderStartDelayTime_BB;                          // 0x110(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         Disable_Escape_Invader;                            // 0x118(0x1)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
