...
public:
	...
	uint8                                        Pad_1C8B[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1C8D[0x50];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1C9A[0x44];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1CAC[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
