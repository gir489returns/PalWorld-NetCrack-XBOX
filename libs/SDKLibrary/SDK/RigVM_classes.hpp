...
public:
	...
	uint8                                        Pad_17B8[0x20];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	struct FRigVMByteCode                        ByteCodeStorage;                                   // 0x60(0x30)(HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_17B9[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_17BD[0x38];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_17BF[0xB8];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_17C0[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_17D4[0x40];                                    // Fixing Size Of Struct [ Dumper-7 ]
