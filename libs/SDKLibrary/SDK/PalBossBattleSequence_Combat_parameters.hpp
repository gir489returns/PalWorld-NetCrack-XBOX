...
public:
	...
	uint8                                        Pad_4355[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	struct FPalDeadInfo                          K2Node_CustomEvent_DeadInfo;                       // 0x18(0x50)(NoDestructor)
	class APalCharacter*                         CallFunc_GetBossCharacter_ReturnValue;             // 0x68(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class UPalDamageReactionComponent*           CallFunc_GetComponentByClass_ReturnValue;          // 0x78(0x8)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
