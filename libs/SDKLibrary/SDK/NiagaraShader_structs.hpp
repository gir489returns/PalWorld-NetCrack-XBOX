...
public:
	...
	uint8                                        BitPad_61 : 4;                                     // Fixing Bit-Field Size  [ Dumper-7 ]
	...
	uint8                                        Pad_701[0x4];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_702[0x28];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_708[0x20];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_70B[0x7];                                      // Fixing Size After Last Property  [ Dumper-7 ]
