...
public:
	...
	uint8                                         Pad_3D7B[0x7];                                     // 0x0001(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3D7C[0x4];                                     // 0x001C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_3D7F[0x3];                                     // 0x0025(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3D80[0x5];                                     // 0x0043(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3D81[0x7];                                     // 0x0061(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3D82[0x3];                                     // 0x0071(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3D83[0x4];                                     // 0x0094(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3D84[0x3];                                     // 0x00C9(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3D85[0x3];                                     // 0x00DD(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3D86[0x2];                                     // 0x0132(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3D87[0x7];                                     // 0x0141(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	class UPalOptionSubsystem*                    CallFunc_GetOptionSubsystem_ReturnValue;           // 0x0338(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                         Pad_3D88[0x7];                                     // 0x03B9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	class UPalHUDDispatchParame_JoinGameInputCode* CallFunc_SpawnObject_ReturnValue_1;                // 0x03F0(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TDelegate<void(class UPalHUDDispatchParameterBase* Param)> K2Node_CreateDelegate_OutputDelegate_6;            // 0x03F8(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	struct FGuid                                  CallFunc_Push_ReturnValue_1;                       // 0x0408(0x0010)(ConstParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                         Pad_3D89[0x7];                                     // 0x0429(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3D8A[0x7];                                     // 0x0441(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3D8B[0x7];                                     // 0x0459(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3D8C[0x7];                                     // 0x0491(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	class FString                                 CallFunc_GetSelectRegion_Region_4;                 // 0x04D0(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	...
	uint8                                         Pad_3D8D[0x5];                                     // 0x04E3(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3D8E[0x7];                                     // 0x0519(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3D8F[0x7];                                     // 0x0531(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3D90[0x2];                                     // 0x054A(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3D91[0x7];                                     // 0x0551(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3D92[0x3];                                     // 0x0569(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3D93[0x7];                                     // 0x0581(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame) == 0x0005B0, "Wrong size on WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame");
...
static_assert(offsetof(WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame, K2Node_CreateDelegate_OutputDelegate) == 0x000004, "Member 'WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame, CallFunc_Dialog_ReturnValue) == 0x000014, "Member 'WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame::CallFunc_Dialog_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame, Temp_bool_Variable) == 0x000024, "Member 'WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame::Temp_bool_Variable' has a wrong offset!");
static_assert(offsetof(WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame, Temp_text_Variable) == 0x000028, "Member 'WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame::Temp_text_Variable' has a wrong offset!");
static_assert(offsetof(WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame, Temp_bool_Variable_1) == 0x000040, "Member 'WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame::Temp_bool_Variable_1' has a wrong offset!");
static_assert(offsetof(WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame, Temp_byte_Variable) == 0x000041, "Member 'WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame::Temp_byte_Variable' has a wrong offset!");
static_assert(offsetof(WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame, Temp_byte_Variable_1) == 0x000042, "Member 'WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame::Temp_byte_Variable_1' has a wrong offset!");
static_assert(offsetof(WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame, CallFunc_GetPassword_ReturnValue) == 0x000048, "Member 'WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame::CallFunc_GetPassword_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame, K2Node_CustomEvent_Param_1) == 0x000058, "Member 'WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame::K2Node_CustomEvent_Param_1' has a wrong offset!");
static_assert(offsetof(WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame, CallFunc_EqualEqual_StrStr_ReturnValue) == 0x000060, "Member 'WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame::CallFunc_EqualEqual_StrStr_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame, K2Node_DynamicCast_AsPal_HUDDispatch_Parame_Join_Game_Input_Code) == 0x000068, "Member 'WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame::K2Node_DynamicCast_AsPal_HUDDispatch_Parame_Join_Game_Input_Code' has a wrong offset!");
static_assert(offsetof(WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame, K2Node_DynamicCast_bSuccess) == 0x000070, "Member 'WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame, K2Node_CreateDelegate_OutputDelegate_1) == 0x000074, "Member 'WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame::K2Node_CreateDelegate_OutputDelegate_1' has a wrong offset!");
static_assert(offsetof(WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame, K2Node_CreateDelegate_OutputDelegate_2) == 0x000084, "Member 'WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame::K2Node_CreateDelegate_OutputDelegate_2' has a wrong offset!");
static_assert(offsetof(WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame, CallFunc_GetHUDService_ReturnValue) == 0x000098, "Member 'WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame::CallFunc_GetHUDService_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame, CallFunc_SpawnObject_ReturnValue) == 0x0000A0, "Member 'WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame::CallFunc_SpawnObject_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame, CallFunc_Push_ReturnValue) == 0x0000A8, "Member 'WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame::CallFunc_Push_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame, CallFunc_GetSelectRegion_Region) == 0x0000B8, "Member 'WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame::CallFunc_GetSelectRegion_Region' has a wrong offset!");
static_assert(offsetof(WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame, CallFunc_IsEmpty_ReturnValue) == 0x0000C8, "Member 'WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame::CallFunc_IsEmpty_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame, K2Node_CreateDelegate_OutputDelegate_3) == 0x0000CC, "Member 'WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame::K2Node_CreateDelegate_OutputDelegate_3' has a wrong offset!");
static_assert(offsetof(WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame, K2Node_CustomEvent_bIsChecked) == 0x0000DC, "Member 'WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame::K2Node_CustomEvent_bIsChecked' has a wrong offset!");
static_assert(offsetof(WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame, K2Node_CreateDelegate_OutputDelegate_4) == 0x0000E0, "Member 'WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame::K2Node_CreateDelegate_OutputDelegate_4' has a wrong offset!");
static_assert(offsetof(WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame, CallFunc_GetSelectRegion_Region_1) == 0x0000F0, "Member 'WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame::CallFunc_GetSelectRegion_Region_1' has a wrong offset!");
static_assert(offsetof(WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame, K2Node_CustomEvent_Address) == 0x000100, "Member 'WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame::K2Node_CustomEvent_Address' has a wrong offset!");
static_assert(offsetof(WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame, CallFunc_Split_LeftS) == 0x000110, "Member 'WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame::CallFunc_Split_LeftS' has a wrong offset!");
static_assert(offsetof(WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame, CallFunc_Split_RightS) == 0x000120, "Member 'WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame::CallFunc_Split_RightS' has a wrong offset!");
static_assert(offsetof(WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame, CallFunc_Split_ReturnValue) == 0x000130, "Member 'WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame::CallFunc_Split_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame, K2Node_CustomEvent_bResult_1) == 0x000131, "Member 'WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame::K2Node_CustomEvent_bResult_1' has a wrong offset!");
static_assert(offsetof(WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame, CallFunc_Conv_StringToInt_ReturnValue) == 0x000134, "Member 'WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame::CallFunc_Conv_StringToInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame, K2Node_ComponentBoundEvent_Widget) == 0x000138, "Member 'WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame::K2Node_ComponentBoundEvent_Widget' has a wrong offset!");
static_assert(offsetof(WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame, K2Node_CustomEvent_bResult) == 0x000140, "Member 'WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame::K2Node_CustomEvent_bResult' has a wrong offset!");
static_assert(offsetof(WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame, CallFunc_Conv_ObjectToSoftObjectReference_ReturnValue) == 0x000148, "Member 'WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame::CallFunc_Conv_ObjectToSoftObjectReference_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame, CallFunc_GetBindedServerDisplayData_DisplayData) == 0x000178, "Member 'WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame::CallFunc_GetBindedServerDisplayData_DisplayData' has a wrong offset!");
static_assert(offsetof(WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame, K2Node_ComponentBoundEvent_SearchWord) == 0x000318, "Member 'WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame::K2Node_ComponentBoundEvent_SearchWord' has a wrong offset!");
static_assert(offsetof(WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame, K2Node_CreateDelegate_OutputDelegate_5) == 0x000328, "Member 'WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame::K2Node_CreateDelegate_OutputDelegate_5' has a wrong offset!");
static_assert(offsetof(WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame, CallFunc_GetOptionSubsystem_ReturnValue) == 0x000338, "Member 'WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame::CallFunc_GetOptionSubsystem_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame, CallFunc_Conv_StringToText_ReturnValue) == 0x000340, "Member 'WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame::CallFunc_Conv_StringToText_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame, K2Node_MakeStruct_FormatArgumentData) == 0x000358, "Member 'WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame::K2Node_MakeStruct_FormatArgumentData' has a wrong offset!");
static_assert(offsetof(WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame, K2Node_MakeArray_Array) == 0x0003A8, "Member 'WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame::K2Node_MakeArray_Array' has a wrong offset!");
static_assert(offsetof(WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame, CallFunc_IsChecked_ReturnValue) == 0x0003B8, "Member 'WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame::CallFunc_IsChecked_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame, CallFunc_Format_ReturnValue) == 0x0003C0, "Member 'WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame::CallFunc_Format_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame, CallFunc_Conv_TextToString_ReturnValue) == 0x0003D8, "Member 'WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame::CallFunc_Conv_TextToString_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame, CallFunc_GetHUDService_ReturnValue_1) == 0x0003E8, "Member 'WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame::CallFunc_GetHUDService_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame, CallFunc_SpawnObject_ReturnValue_1) == 0x0003F0, "Member 'WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame::CallFunc_SpawnObject_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame, K2Node_CreateDelegate_OutputDelegate_6) == 0x0003F8, "Member 'WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame::K2Node_CreateDelegate_OutputDelegate_6' has a wrong offset!");
static_assert(offsetof(WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame, CallFunc_Push_ReturnValue_1) == 0x000408, "Member 'WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame::CallFunc_Push_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame, K2Node_CustomEvent_Param) == 0x000418, "Member 'WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame::K2Node_CustomEvent_Param' has a wrong offset!");
static_assert(offsetof(WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame, K2Node_DynamicCast_AsPal_HUDDispatch_Parame_Join_Game_Input_Code_1) == 0x000420, "Member 'WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame::K2Node_DynamicCast_AsPal_HUDDispatch_Parame_Join_Game_Input_Code_1' has a wrong offset!");
static_assert(offsetof(WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame, K2Node_DynamicCast_bSuccess_1) == 0x000428, "Member 'WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame::K2Node_DynamicCast_bSuccess_1' has a wrong offset!");
static_assert(offsetof(WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame, CallFunc_GetSelectRegion_Region_2) == 0x000430, "Member 'WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame::CallFunc_GetSelectRegion_Region_2' has a wrong offset!");
static_assert(offsetof(WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame, K2Node_SwitchEnum_CmpSuccess) == 0x000440, "Member 'WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame::K2Node_SwitchEnum_CmpSuccess' has a wrong offset!");
static_assert(offsetof(WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame, CallFunc_GetSelectRegion_Region_3) == 0x000448, "Member 'WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame::CallFunc_GetSelectRegion_Region_3' has a wrong offset!");
static_assert(offsetof(WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame, CallFunc_IsEmpty_ReturnValue_1) == 0x000458, "Member 'WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame::CallFunc_IsEmpty_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame, CallFunc_Conv_StringToText_ReturnValue_1) == 0x000460, "Member 'WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame::CallFunc_Conv_StringToText_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame, K2Node_Select_Default) == 0x000478, "Member 'WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame, CallFunc_IsChecked_ReturnValue_1) == 0x000490, "Member 'WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame::CallFunc_IsChecked_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame, CallFunc_GetText_ReturnValue) == 0x000498, "Member 'WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame::CallFunc_GetText_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame, CallFunc_Conv_TextToString_ReturnValue_1) == 0x0004B0, "Member 'WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame::CallFunc_Conv_TextToString_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame, K2Node_CreateDelegate_OutputDelegate_7) == 0x0004C0, "Member 'WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame::K2Node_CreateDelegate_OutputDelegate_7' has a wrong offset!");
static_assert(offsetof(WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame, CallFunc_GetSelectRegion_Region_4) == 0x0004D0, "Member 'WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame::CallFunc_GetSelectRegion_Region_4' has a wrong offset!");
static_assert(offsetof(WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame, K2Node_ComponentBoundEvent_SortType) == 0x0004E0, "Member 'WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame::K2Node_ComponentBoundEvent_SortType' has a wrong offset!");
static_assert(offsetof(WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame, CallFunc_IsCanPlayDedicatedServerIP_ReturnValue) == 0x0004E1, "Member 'WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame::CallFunc_IsCanPlayDedicatedServerIP_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame, K2Node_Select_Default_1) == 0x0004E2, "Member 'WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame::K2Node_Select_Default_1' has a wrong offset!");
static_assert(offsetof(WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame, Temp_string_Variable) == 0x0004E8, "Member 'WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame::Temp_string_Variable' has a wrong offset!");
static_assert(offsetof(WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame, CallFunc_FromString_OutJsonObject) == 0x0004F8, "Member 'WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame::CallFunc_FromString_OutJsonObject' has a wrong offset!");
static_assert(offsetof(WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame, CallFunc_FromString_ReturnValue) == 0x000518, "Member 'WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame::CallFunc_FromString_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame, CallFunc_GetField_OutValue) == 0x000520, "Member 'WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame::CallFunc_GetField_OutValue' has a wrong offset!");
static_assert(offsetof(WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame, CallFunc_GetField_ReturnValue) == 0x000530, "Member 'WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame::CallFunc_GetField_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame, CallFunc_GetField_OutValue_1) == 0x000538, "Member 'WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame::CallFunc_GetField_OutValue_1' has a wrong offset!");
static_assert(offsetof(WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame, CallFunc_GetField_ReturnValue_1) == 0x000548, "Member 'WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame::CallFunc_GetField_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame, Temp_bool_Variable_2) == 0x000549, "Member 'WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame::Temp_bool_Variable_2' has a wrong offset!");
static_assert(offsetof(WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame, Temp_int_Variable) == 0x00054C, "Member 'WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame::Temp_int_Variable' has a wrong offset!");
static_assert(offsetof(WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame, CallFunc_IsEmpty_ReturnValue_2) == 0x000550, "Member 'WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame::CallFunc_IsEmpty_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame, K2Node_CustomEvent_ResponseBody) == 0x000558, "Member 'WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame::K2Node_CustomEvent_ResponseBody' has a wrong offset!");
static_assert(offsetof(WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame, K2Node_CustomEvent_bResponseOK) == 0x000568, "Member 'WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame::K2Node_CustomEvent_bResponseOK' has a wrong offset!");
static_assert(offsetof(WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame, K2Node_CustomEvent_ResponseCode) == 0x00056C, "Member 'WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame::K2Node_CustomEvent_ResponseCode' has a wrong offset!");
static_assert(offsetof(WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame, K2Node_CreateDelegate_OutputDelegate_8) == 0x000570, "Member 'WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame::K2Node_CreateDelegate_OutputDelegate_8' has a wrong offset!");
static_assert(offsetof(WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame, CallFunc_Array_Contains_ReturnValue) == 0x000580, "Member 'WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame::CallFunc_Array_Contains_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame, CallFunc_GetSelectRegion_Region_5) == 0x000588, "Member 'WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame::CallFunc_GetSelectRegion_Region_5' has a wrong offset!");
static_assert(offsetof(WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame, CallFunc_GetGameInstanceSubsystem_ReturnValue) == 0x000598, "Member 'WBP_JoinGame_C_ExecuteUbergraph_WBP_JoinGame::CallFunc_GetGameInstanceSubsystem_ReturnValue' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_3D94[0x6];                                     // 0x0002(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_3D95[0x3];                                     // 0x0011(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
