...
{
public:
	uint8                                         Pad_16F1[0x1D0];                                   // 0x0028(0x01D0)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_16F2[0x60];                                    // 0x0028(0x0060)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_16F3[0x4];                                     // 0x0098(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_16F4[0x8];                                     // 0x00A0(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_16F5[0x4];                                     // 0x00B0(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_16F6[0x23];                                    // 0x00B5(0x0023)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_16F7[0x26];                                    // 0x00EA(0x0026)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_16F8[0x58];                                    // 0x0198(0x0058)(Fixing Struct Size After Last Property [ Dumper-7 ])
