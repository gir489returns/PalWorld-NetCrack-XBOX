...
{
public:
	uint8                                         Pad_16D8[0x1D0];                                   // 0x0028(0x01D0)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_16D9[0x60];                                    // 0x0028(0x0060)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_16DA[0x4];                                     // 0x0098(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_16DB[0x8];                                     // 0x00A0(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_16DC[0x4];                                     // 0x00B0(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_16DD[0x23];                                    // 0x00B5(0x0023)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_16DE[0x26];                                    // 0x00EA(0x0026)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_16DF[0x58];                                    // 0x0198(0x0058)(Fixing Struct Size After Last Property [ Dumper-7 ])
