...
public:
	...
	uint8                                        Pad_90F[0x6];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_9C7[0x28];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_9CA[0x4];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_AA7[0x18];                                     // Fixing Size After Last Property  [ Dumper-7 ]
