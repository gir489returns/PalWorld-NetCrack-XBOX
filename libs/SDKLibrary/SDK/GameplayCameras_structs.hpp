...
public:
	...
	uint8                                        Pad_2F1[0x2];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_2F5[0x3];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2F7[0x2];                                      // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_2F9[0x4];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_2FB[0x4];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2FD[0x6];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_2FF[0x3];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
