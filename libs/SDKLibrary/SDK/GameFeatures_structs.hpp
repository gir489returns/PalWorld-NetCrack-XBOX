...
{
public:
	uint8                                        Pad_D64[0x88];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_D66[0x38];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_D67[0x28];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_D69[0x20];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
