...
{
public:
	uint8                                        Pad_DFC[0x88];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_DFE[0x38];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_E00[0x20];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
