...
{
public:
	uint8                                        Pad_CD6[0x38];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_CE4[0x20];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_CE5[0x6];                                      // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_CEC[0x40];                                     // Fixing Size Of Struct [ Dumper-7 ]
