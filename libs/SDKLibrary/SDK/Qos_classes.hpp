...
{
public:
	uint8                                        Pad_113D[0x38];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1141[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1146[0x20];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1149[0x20];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1157[0x40];                                    // Fixing Size Of Struct [ Dumper-7 ]
