...
public:
	...
	uint8                                        Pad_1C54[0x4];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1C5E[0x68];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1C69[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1C6B[0x198];                                   // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1C6E[0x68];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1C71[0xC];                                     // Fixing Size Of Struct [ Dumper-7 ]
