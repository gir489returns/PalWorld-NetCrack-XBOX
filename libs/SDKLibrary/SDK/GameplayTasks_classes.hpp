...
public:
	...
	uint8                                        Pad_29E2[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_29E3[0x25];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_29EA[0x7];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_2A01[0x14];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	uint8                                        BitPad_1A2 : 1;                                    // Fixing Bit-Field Size  [ Dumper-7 ]
	...
	uint8                                        Pad_2A03[0x10];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_2A30[0x30];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_2A35[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
