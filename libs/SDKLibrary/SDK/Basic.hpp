...
namespace Offsets
{
	constexpr int32 GObjects          = 0x08180FB0;
	constexpr int32 AppendString      = 0x02C28800;
	constexpr int32 GNames            = 0x080E1C00;
	constexpr int32 GWorld            = 0x082EED28;
	constexpr int32 ProcessEvent      = 0x02DAAEE0;
