...
namespace Offsets
{
	constexpr int32 GObjects          = 0x082C8530;
	constexpr int32 AppendString      = 0x02CFFFC0;
	constexpr int32 GNames            = 0x08229180;
	constexpr int32 GWorld            = 0x08436178;
	constexpr int32 ProcessEvent      = 0x02E82500;
