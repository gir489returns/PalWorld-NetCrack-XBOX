...
namespace Offsets
{
	constexpr int32 GObjects          = 0x089C7C00;
	constexpr int32 AppendString      = 0x02E3A0F0;
	constexpr int32 GNames            = 0x08928500;
	constexpr int32 GWorld            = 0x08B35820;
	constexpr int32 ProcessEvent      = 0x02FBCBF0;
