...
namespace Offsets
{
	constexpr int32 GObjects          = 0x08883980;
	constexpr int32 AppendString      = 0x02D5AA10;
	constexpr int32 GNames            = 0x087E4280;
	constexpr int32 GWorld            = 0x089F1698;
	constexpr int32 ProcessEvent      = 0x02EDD490;
