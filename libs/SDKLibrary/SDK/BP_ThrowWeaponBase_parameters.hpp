...
public:
	...
	uint8                                        Pad_1A72[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1A74[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
struct ABP_ThrowWeaponBase_C_On_Throw_Params
{
public:
	...
	TMap<class FName, class APalWeaponBase*>     CallFunc_GetPalSphereActorMap_ReturnValue;         // 0x10(0x50)(None)
	class FName                                  CallFunc_GetNowEquipedBallItemID_OutBallItemID;    // 0x60(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FRotator                              CallFunc_GetBulletShootRotation_BulletRotate;      // 0x68(0x18)(ZeroConstructor, IsPlainOldData, NoDestructor)
	class APalWeaponBase*                        CallFunc_Map_Find_Value;                           // 0x80(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	int32                                        CallFunc_CountItemNum_ReturnValue;                 // 0x8C(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	float                                        CallFunc_GetSneakAttackRate_ReturnValue;           // 0x94(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                        CallFunc_GetWeaponDamage_ReturnValue;              // 0x98(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_DecrementBullet_ReturnValue;              // 0x9C(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_1ACA[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class UClass*                                CallFunc_GetThrowObjectClass_ThrowObject;          // 0xA0(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class APalCharacter*                         CallFunc_FindOwnerPalCharacter_ReturnValue;        // 0xA8(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class UPalLoadoutSelectorComponent*          CallFunc_GetComponentByClass_ReturnValue;          // 0xB8(0x8)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	class AActor*                                CallFunc_FinishSpawningActor_ReturnValue;          // 0x148(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class APalBullet*                            K2Node_DynamicCast_AsPal_Bullet;                   // 0x150(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
