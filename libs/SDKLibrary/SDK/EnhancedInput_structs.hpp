...
{
public:
	uint8                                        Pad_1FA8[0x20];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_1FB8[0xB];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1FBA[0x20];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1FC0[0x3];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
