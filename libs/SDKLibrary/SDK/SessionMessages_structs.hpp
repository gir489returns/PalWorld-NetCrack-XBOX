...
public:
	...
	uint8                                        Pad_2CF0[0x7];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_2CF7[0x7];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_2CF8[0x1];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_2D02[0x1];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
