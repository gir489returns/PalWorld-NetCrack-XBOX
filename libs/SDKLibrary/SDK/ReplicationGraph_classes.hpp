...
public:
	...
	uint8                                        Pad_13C7[0x40];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_13C8[0x4B8];                                   // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_13CA[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_13CC[0xB8];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_13CD[0x30];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_13CE[0x80];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_13D0[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_13D2[0x40];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_13D3[0x210];                                   // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_13D6[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_13D9[0x10];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_13DC[0x1F0];                                   // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_13DD[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	TArray<struct FLastLocationGatherInfo>       LastGatherLocations;                               // 0x230(0x10)(ZeroConstructor, NativeAccessSpecifierPublic)
	uint8                                        Pad_13DF[0x58];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_13E0[0xD0];                                    // Fixing Size Of Struct [ Dumper-7 ]
