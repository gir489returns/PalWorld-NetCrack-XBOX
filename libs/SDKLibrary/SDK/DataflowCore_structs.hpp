...
{
public:
	uint8                                        Pad_2C01[0xC8];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_2C04[0x40];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_2C06[0x28];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
