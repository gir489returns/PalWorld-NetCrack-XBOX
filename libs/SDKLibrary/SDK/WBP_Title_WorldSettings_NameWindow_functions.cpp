...
#include "WBP_Title_WorldSettings_NameWindow_classes.hpp"
#include "WBP_Title_WorldSettings_NameWindow_parameters.hpp"
...
void UWBP_Title_WorldSettings_NameWindow_C::BndEvt__WBP_Title_WorldSettings_NameWindow_EditableTextBox_Name_K2Node_ComponentBoundEvent_1_OnEditableTextBoxCommittedEvent__DelegateSignature(const class FText& Text, ETextCommit CommitMethod)
{
	static class UFunction* Func = nullptr;
	...
	Params::WBP_Title_WorldSettings_NameWindow_C_BndEvt__WBP_Title_WorldSettings_NameWindow_EditableTextBox_Name_K2Node_ComponentBoundEvent_1_OnEditableTextBoxCommittedEvent__DelegateSignature Parms{};
...
void UWBP_Title_WorldSettings_NameWindow_C::BndEvt__WBP_Title_WorldSettings_NameWindow_EditableTextBox_Name_K2Node_ComponentBoundEvent_0_OnEditableTextBoxChangedEvent__DelegateSignature(const class FText& Text)
{
	static class UFunction* Func = nullptr;
...
class UWidget* UWBP_Title_WorldSettings_NameWindow_C::BP_GetDesiredFocusTarget() const
{
	static class UFunction* Func = nullptr;
	...
	Params::WBP_Title_WorldSettings_NameWindow_C_BP_GetDesiredFocusTarget Parms{};
