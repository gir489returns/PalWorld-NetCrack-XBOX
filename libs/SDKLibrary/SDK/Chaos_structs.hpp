...
{
public:
	uint8                                        Pad_247C[0xB0];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_24A0[0x3];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_24B2[0x4];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_24C0[0x4];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
