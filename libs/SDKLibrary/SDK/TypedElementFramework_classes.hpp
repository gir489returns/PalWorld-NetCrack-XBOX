...
{
public:
	uint8                                        Pad_275F[0x920];                                   // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_2784[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_2787[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
