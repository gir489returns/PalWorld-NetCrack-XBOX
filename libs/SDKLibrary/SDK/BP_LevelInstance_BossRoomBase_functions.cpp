...
// Parameters:
// class ABP_BossBattle_BossCharacterSpawner_C*Param_BossSpawner                                      (Parm, OutParm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)

void ABP_LevelInstance_BossRoomBase_C::GetBossSpawner(class ABP_BossBattle_BossCharacterSpawner_C** Param_BossSpawner)
{
	static class UFunction* Func = nullptr;
	...
	if (Param_BossSpawner != nullptr)
		*Param_BossSpawner = Parms.Param_BossSpawner;
}
