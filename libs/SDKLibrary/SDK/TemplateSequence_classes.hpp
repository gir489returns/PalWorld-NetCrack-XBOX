...
public:
	...
	uint8                                        Pad_175A[0xC];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_175C[0x7C];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_175F[0x260];                                   // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1760[0x60];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_176E[0x70];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1773[0x58];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1776[0x50];                                    // Fixing Size Of Struct [ Dumper-7 ]
