...
{
public:
	uint8                                        Pad_DDC[0x18];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_DDD[0x8];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	struct FPartyMemberPlatformData              PlatformData;                                      // 0x20(0x98)(NativeAccessSpecifierPrivate)
	uint8                                        Pad_DDE[0x90];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_DF2[0x35];                                     // Fixing Size After Last Property  [ Dumper-7 ]
