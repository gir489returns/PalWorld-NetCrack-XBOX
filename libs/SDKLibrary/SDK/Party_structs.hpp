...
{
public:
	uint8                                        Pad_1212[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_1218[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FPartyMemberPlatformData              PlatformData;                                      // 0x20(0x98)(NativeAccessSpecifierPrivate)
	uint8                                        Pad_121A[0x90];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_121D[0x37];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1220[0x60];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_122A[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FPartyPrivacySettings                 PrivacySettings;                                   // 0x20(0x3)(NoDestructor, Protected, NativeAccessSpecifierProtected)
	uint8                                        Pad_122B[0x35];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_122C[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
