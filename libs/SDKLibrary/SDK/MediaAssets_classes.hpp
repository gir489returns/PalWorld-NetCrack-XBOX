...
{
public:
	uint8                                        Pad_1AD8[0x58];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1B16[0xB8];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1B3A[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1B3E[0xB8];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1B40[0x17];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1C13[0x28];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1C14[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1C68[0x7];                                     // Fixing Size Of Struct [ Dumper-7 ]
