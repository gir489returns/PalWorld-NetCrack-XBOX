...
public:
	...
	uint8                                        Pad_1399[0x76];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_13A3[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_13B3[0x48];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_13BC[0x68];                                    // Fixing Size Of Struct [ Dumper-7 ]
