...
public:
	...
	struct FGuid                                 CallFunc_Dialog_ReturnValue;                       // 0xD0(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UPalDebugSetting*                      CallFunc_GetPalDebugSetting_ReturnValue;           // 0xE8(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class UPalGameInstance*                      CallFunc_GetPalGameInstance_ReturnValue;           // 0xF8(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
