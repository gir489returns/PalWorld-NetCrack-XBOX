...
public:
	...
	class ULoadingProcessTask*                   CurrentLoadingTask;                                // 0x778(0x8)(Edit, BlueprintVisible, ZeroConstructor, Transient, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
